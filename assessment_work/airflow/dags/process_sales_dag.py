...
with DAG(
    ...
    description="Pipeline to process sales data: raw → bronze → silver",
    ...
    raw_to_bronze = GlueJobOperator(
        ...
        script_location="s3://aws-glue-assets-752953535939-us-east-1/scripts/process_sales_raw_to_bronze.py",
    ...
    bronze_to_silver = GlueJobOperator(
        ...
        script_location="s3://aws-glue-assets-752953535939-us-east-1/scripts/process_sales_bronze_to_silver.py",
        region_name="us-east-1",
        iam_role_name="ab-data-platform-glue-service-role",
        create_job_kwargs={
            "GlueVersion": "5.0",
